      ...
      <section className="py-16 border-t border-border">
        <div className="mx-auto max-w-2xl px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="https://fragmentfi-docs-site.vercel.app" target="_blank" rel="noopener noreferrer" className="rounded-full px-8 py-3 text-sm font-semibold text-foreground border border-border hover:bg-muted transition-colors">
              Read Docs
            </Link>
          </div>
        </div>
